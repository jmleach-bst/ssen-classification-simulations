...
# to store errors
file.create(paste0("/data/user/jleach/sim_06_2021/errors/errors_test_glmnet_N500_50x50_500.txt"))
  ...
  tryCatch(
    ...
    error = function(e) {
      ...
      write_lines(paste("Iteration #", m , ":", as.character(e)),
                  path = "/data/user/jleach/sim_06_2021/errors/errors_test_glmnet_N500_50x50_500.txt",
                  append = TRUE)
    },
    finally = {
...
saveRDS(out,
        file = paste0("/data/user/jleach/sim_06_2021/results/results_test_glmnet_N500_50x50_500.RDS"))
