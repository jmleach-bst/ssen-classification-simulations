...
# load data
simdata <- readRDS(file = paste0("/data/user/jleach/sim_06_2021/simdata/simdata_N250_40x40_",
                                 runID, ".RDS"))
...
# to store errors
file.create(paste0("/data/user/jleach/sim_06_2021/errors/errors_ssnet_N250_40x40_500_",
                   runID, ".txt"))
  ...
  tryCatch(
    ...
    error = function(e) {
      ...
      write_lines(paste("Iteration #", m , ":", as.character(e)),
                  path = paste0("/data/user/jleach/sim_06_2021/errors/errors_ssnet_N250_40x40_500_",
                                runID, ".txt"),
                  append = TRUE)
    },
    finally = {
...
saveRDS(out,
        file = paste0("/data/user/jleach/sim_06_2021/results/results_ssnet_N250_40x40_500_",
                      runID, ".RDS"))
