...
if (runID %in% 1:2) {
  simdata <- readRDS(file = "/data/user/jleach/sim_06_2021/simdata/simdata_N500_50x50_1.RDS")
  if (runID == 1) {
...
if (runID %in% 3:4) {
  simdata <- readRDS(file = "/data/user/jleach/sim_06_2021/simdata/simdata_N500_50x50_2.RDS")
  if (runID == 3) {
    simdata <- simdata[1:250]
  } 
  if (runID == 4) {
...
if (runID %in% 5:6) {
  simdata <- readRDS(file = "/data/user/jleach/sim_06_2021/simdata/simdata_N500_50x50_3.RDS")
  if (runID == 5) {
    simdata <- simdata[1:250]
  } 
  if (runID == 6) {
...
if (runID %in% 7:8) {
  simdata <- readRDS(file = "/data/user/jleach/sim_06_2021/simdata/simdata_N500_50x50_4.RDS")
  if (runID == 7) {
    simdata <- simdata[1:250]
  } 
  if (runID == 8) {
...
if (runID %in% 9:10) {
  simdata <- readRDS(file = "/data/user/jleach/sim_06_2021/simdata/simdata_N500_50x50_5.RDS")
  if (runID == 9) {
    simdata <- simdata[1:250]
  } 
  if (runID == 10) {
...
if (runID %in% 11:12) {
  simdata <- readRDS(file = "/data/user/jleach/sim_06_2021/simdata/simdata_N500_50x50_6.RDS")
  if (runID == 11) {
    simdata <- simdata[1:250]
  } 
  if (runID == 12) {
...
if (runID %in% 13:14) {
  simdata <- readRDS(file = "/data/user/jleach/sim_06_2021/simdata/simdata_N500_50x50_7.RDS")
  if (runID == 13) {
    simdata <- simdata[1:250]
  } 
  if (runID == 14) {
...
if (runID %in% 15:16) {
  simdata <- readRDS(file = "/data/user/jleach/sim_06_2021/simdata/simdata_N500_50x50_8.RDS")
  if (runID == 15) {
    simdata <- simdata[1:250]
  } 
  if (runID == 16) {
...
if (runID %in% 17:18) {
  simdata <- readRDS(file = "/data/user/jleach/sim_06_2021/simdata/simdata_N500_50x50_9.RDS")
  if (runID == 17) {
    simdata <- simdata[1:250]
  } 
  if (runID == 18) {
...
if (runID %in% 19:20) {
  simdata <- readRDS(file = "/data/user/jleach/sim_06_2021/simdata/simdata_N500_50x50_10.RDS")
  if (runID == 19) {
    simdata <- simdata[1:250]
  } 
  if (runID == 20) {
...
# to store errors
file.create(paste0("/data/user/jleach/sim_06_2021/errors/errors_ssnet_iar_N500_50x50_250_",
                   runID, ".txt"))
  ...
  tryCatch(
    ...
    error = function(e) {
      ...
      write_lines(paste("Iteration #", m , ":", as.character(e)),
                  path = paste0("/data/user/jleach/sim_06_2021/errors/errors_ssnet_iar_N500_50x50_250_",
                                runID, ".txt"),
                  append = TRUE)
    },
    finally = {
...
saveRDS(out,
        file = paste0("/data/user/jleach/sim_06_2021/results/results_ssnet_iar_N500_50x50_250_",
                      runID, ".RDS"))