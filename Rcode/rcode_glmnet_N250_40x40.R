...
# to store errors
file.create(paste0("/data/user/jleach/sim_06_2021/errors/errors_glmnet_N250_40x40.txt"))
  ...
  tryCatch(
    ...
    error = function(e) {
      ...
      write_lines(paste("Iteration #", m , ":", as.character(e)),
                  path = paste0("/data/user/jleach/sim_06_2021/errors/errors_glmnet_N250_40x40.txt"),
                  append = TRUE)
    },
    finally = {
...
saveRDS(out,
        file = paste0("/data/user/jleach/sim_06_2021/results/results_glmnet_N250_40x40.RDS"))
